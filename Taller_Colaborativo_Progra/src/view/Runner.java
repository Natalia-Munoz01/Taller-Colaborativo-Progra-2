...
public class Runner {
	...
	public void menu() {
		...
		while (continuar == true) {
			...
			case 4:
				JOptionPane.showMessageDialog(null,
						"La cantidad de vocales encontradas en la cadena es de:" + obj.ContarVocales(cadenaOriginal));
				break;
			case 5:
			...
			case 7:
				...
				JOptionPane.showMessageDialog(null, "La cadena resultante tras eliminar el caracter : " + c + "  es: "
						+ obj.BorrarCaracter(cadenaOriginal, c));
				break;
			case 8:
			...
			case 9:
				...
				break;
			case 10:
				JOptionPane.showMessageDialog(null, "La cantidad de palabras encontradas en la cadena de texto es: "
						+ obj.ContarPalabras(cadenaOriginal));
				break;
			case 11:
				JOptionPane.showMessageDialog(null,
						"El correo " + cadenaOriginal + " es: " + obj.ValidarCorreo(cadenaOriginal));
				break;
			case 12:
				continuar = false;
